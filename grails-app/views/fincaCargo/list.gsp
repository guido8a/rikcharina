...
<script type="text/javascript">
    ...
    function cargarTablaCargo(){
        $.ajax({
            type: 'POST',
            url:'${createLink(controller: 'fincaCargo', action: 'tablaFincaCargo_ajax')}',
            data:{finca: '${finca}'},
    ...
    function createEditCargo(id) {
        ...
        $.ajax({
            type    : "POST",
            url     : "${createLink(controller:'fincaCargo', action:'form_ajax')}",
            data    : data,
            success : function (msg) {
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if(result){
                    $.ajax({
                        type:'POST',
                        url:'${createLink(controller: 'fincaCargo', action: 'borrarFincaCargo_ajax')}',
                        data:{
                            id: id
                        },
                        success:function(msg){
