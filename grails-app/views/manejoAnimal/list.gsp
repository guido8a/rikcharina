...
<script type="text/javascript">
    ...
    function cargarTablaAnimal(){
        $.ajax({
            type: 'POST',
            url:'${createLink(controller: 'manejoAnimal', action: 'tablaManejoAnimal_ajax')}',
            data:{finca: '${finca}'},
    ...
    function createEditAnimal(id) {
        ...
        $.ajax({
            type    : "POST",
            url     : "${createLink(controller:'manejoAnimal', action:'form_ajax')}",
            data    : data,
            success : function (msg) {
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if(result){
                    $.ajax({
                        type:'POST',
                        url:'${createLink(controller: 'manejoAnimal', action: 'borrarManejoAnimal_ajax')}',
                        data:{
                            id: id
                        },
                        success:function(msg){
